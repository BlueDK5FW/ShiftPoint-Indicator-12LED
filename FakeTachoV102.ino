...
#define TIME5 500 //Time5(msec)
#define TIME6 1500 //Time6(msec)
#define TIME7 3000 //Time7(msec)
#define TIME8 5000 //Time8(msec)
...
#define SPEED2 35 //2速→3速チェンジ時のスピード
...
//↑*/
  ...
  if(nowTime - beforeTime > TIME7){   //前回～今回3秒以上→0.5km以下
    elapsedTime = 0.0;
  }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
//               Gear Section  
...
//加速度からギア比補正
  if (y  > AGGRESSIVE_ACC || y < AGGRESSIVE_BRK){
    if (!aggrStartTime) {
      aggrStartTime = millis();
    }
    if (aggrStartTime + TIME5 <  millis()) {  //段差乗上等、0.5秒未満のy値大変動では反応させない
      ...
      aggrStartTime = 0;
    }  //END aggrStartTime + TIME5 <  millis()
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if (carSpeed >= 1.0 && y > AGGRESSIVE_ACC && lastY > AGGRESSIVE_ACC && last2Y > AGGRESSIVE_ACC && last3Y > AGGRESSIVE_ACC) {
    ...
    if (aggrStartTime2 + TIME5 <  millis()) {  //段差乗上等0.5秒未満のy大変動ではblinkさせない
      if (!blinkFlg) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  lastY = y;
  loopCnt++;
  if (acceleroTime + TIME8 <  millis()) {  //acceleroBlinkは1度なったら5秒間はacceleroBlinkにしない
    acceleroTime = blinkFlg = 0;
  }
  if (aggrStartTime && (aggrStartTime + TIME5 <  millis())) {
    aggrStartTime = 0;
  }
  if (aggrStartTime2 && (aggrStartTime2 + TIME5 <  millis())) {
    aggrStartTime2 = 0;
  }
}  //END loop()
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
